...
QUnit.test("modify title part", async (assert) => {
    ...
    env.services.title.setParts({ z: "Odoo" });
    assert.strictEqual(env.services.title.current, "Odoo");
    env.services.title.setParts({ z: "Z" });
    assert.strictEqual(env.services.title.current, "Z");
});
...
QUnit.test("delete title part", async (assert) => {
    ...
    env.services.title.setParts({ z: "Odoo" });
    assert.strictEqual(env.services.title.current, "Odoo");
    env.services.title.setParts({ z: null });
