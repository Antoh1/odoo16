...
class PurchaseRequisition(models.Model):
    ...
    dept_id = fields.Many2one('hr.department', string='Department',
                              ...
                              help='Department')
    user_id = fields.Many2one('res.users', string='Requisition Manager',
                              required=True,
    ...
    confirmed_date = fields.Date(string='Confirmation Date', readonly=True,
...
class RequisitionProducts(models.Model):
    ...
    partner_id = fields.Many2one('res.partner', string='Vendor',
                                 help='Vendor for the requisition', domain="[('is_vendor', '=', True)]")
