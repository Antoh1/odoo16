...
class Prescription(models.Model):
    ...
    patient_id = fields.Many2one('res.partner', 'Patient', domain="[('patient_seq', '!=', 'New')]")
    ...
    doctor_id = fields.Many2one('hr.employee', 'Doctor', domain="[('is_doctor','=','doctor')]")
    ...
    prescription_seq = fields.Char(string='Prescription ID', required=True, copy=False, readonly=True, index=True,
    ...
    # prescription_date = fields.Date('Date', default=fields.Date.today)
...
class PrescriptionLines(models.Model):
    ...
    days = fields.Integer('No of Days', help="the no of dys to take the medicine")
    no_intakes = fields.Integer('Intakes', help="How much medicine to take")
