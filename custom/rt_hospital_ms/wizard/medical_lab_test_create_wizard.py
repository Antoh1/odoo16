    ...
    def create_lab_test(self):
        ...
        for browse_record in browse_records:
            ...
            if res_ids:
                ...
                action = self.env.ref('rt_hospital_ms.action_medical_lab_tree')
                list_view_id = imd._xmlid_to_res_id('rt_hospital_ms.medical_lab_tree_view')
                form_view_id  =  imd._xmlid_to_res_id('rt_hospital_ms.medical_lab_form_view')
                result = {
                                'name': action.name,
                                'help': action.help,
                                'type': action.type,
